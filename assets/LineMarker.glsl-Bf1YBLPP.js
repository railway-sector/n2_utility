import{w4 as K,GH as Z,GI as ee,Fi as te,Fg as ie,GJ as re,GK as ae,Fn as o,GA as se,FW as oe,Gz as ne,Fm as z,GL as ce,GM as le,Fj as pe,Fl as de,Fo as he,Gj as ve,Fq as ue,GN as A,GO as N,GP as me,GQ as fe,F_ as ge,g0 as Se,Fr as Pe,Fs as ye,_ as _e,Ft as C,Fu as E,Fv as ze,Fw as R,Fx as L,G0 as we,Fz as xe,FA as $e,FB as Te,FD as V,FE as be,GR as Ve,GS as U,GT as I,GU as ke,GV as Fe,GW as Oe,FF as De,n as p,FG as d,fZ as We,G1 as Ce,GX as B,qC as Le,Gr as Me,kE as je,FL as Ge,de as q,xX as Ae,gz as H,dq as Y,GY as Ne}from"./index-BPPwkOiP.js";function J(r){const e=new K,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:w}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
